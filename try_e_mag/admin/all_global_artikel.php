...
$ambil_artikel=mysql_query ("select id_news,judul_berita_news,sinopsis_berita_news,foto_news,penerbit,link_news,tanggal_post from artikel_news where id_news='$Panggil_id'");
