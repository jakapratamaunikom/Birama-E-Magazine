...
<td></td>
  ...
  <tr>
    ...
    <td width="83" rowspan="4" ><a href="../admin/proses_rubah.php?menu=full_global_edit&amp;id_news=<?php echo $id_news."&judul_berita_news=".$Judul_Berita_News; ?>" target="_blank">Edit</a>
    <br>
    <hr size="3%">
    <a href="../admin/proses_hapus_artikel.php?menu=full_global_delete&amp;id_news=<?php echo $id_news."&judul_berita_news=".$Judul_Berita_News; ?>" target="_blank">Hapus</a></td>
  </tr>
  <tr>
